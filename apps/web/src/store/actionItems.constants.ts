...
export const SEED_ITEMS: ActionItem[] = [
  { id: 1, title: "Ship pricing page copy before board deck", owner: "Rachel Ng", due: "2026-08-14", priority: "High", confidence: 96, status: "In progress", saved: false, note: "“pricing page needs to be live before the board deck goes out”", meeting: "Weekly Sync — Aug 10" },
  { id: 2, title: "Land fix for API rate limits on mobile", owner: "Kyle Park", due: "2026-08-17", priority: "High", confidence: 91, status: "Not started", saved: false, note: "“wants a fix landed next week”", meeting: "Weekly Sync — Aug 10" },
  { id: 3, title: "Draft churn analysis deck for board", owner: "Marcus Hale", due: "2026-08-20", priority: "Medium", confidence: 74, status: "Not started", saved: false, note: "Date inferred from “sometime before the 20th?” — confirm the deadline.", meeting: "Weekly Sync — Aug 10" },
  { id: 4, title: "Rewrite onboarding email sequence", owner: "Priya Shah", due: "2026-08-28", priority: "Low", confidence: 88, status: "Not started", saved: false, note: "“onboarding email sequence rewrite, low urgency”", meeting: "Weekly Sync — Aug 10" },
  { id: 5, title: "Follow up with Northwind on renewal", owner: "Unassigned", due: "2026-08-21", priority: "Medium", confidence: 52, status: "Blocked", saved: false, note: "No owner named in the transcript, and the date is a guess.", meeting: "Weekly Sync — Aug 10" },
  { id: 6, title: "Decide on deprecating legacy export endpoint", owner: "Kyle Park", due: "", priority: "Low", confidence: 61, status: "Not started", saved: false, note: "No date discussed — added as unscheduled.", meeting: "Weekly Sync — Aug 10" },
  { id: 20, title: "Send revised SOC 2 evidence to Northwind", owner: "Rachel Ng", due: "2026-08-11", priority: "High", confidence: 94, status: "Done", saved: true, completed: "2026-08-10", meeting: "Northwind kickoff — Jul 22" },
  { id: 21, title: "Cut mobile bundle under 400kb", owner: "Kyle Park", due: "2026-08-10", priority: "High", confidence: 90, status: "Done", saved: true, completed: "2026-08-10", meeting: "Design review — Aug 6" },
  { id: 22, title: "Finalize Q3 headcount plan", owner: "Marcus Hale", due: "2026-08-07", priority: "Medium", confidence: 87, status: "Done", saved: true, completed: "2026-08-06", meeting: "Q3 planning — Jul 29" },
  { id: 23, title: "Ship empty-state copy for Tasks", owner: "Priya Shah", due: "2026-08-07", priority: "Low", confidence: 82, status: "Done", saved: true, completed: "2026-08-05", meeting: "Design review — Aug 6" },
  { id: 24, title: "Migrate billing webhooks to v2", owner: "Kyle Park", due: "2026-08-03", priority: "High", confidence: 93, status: "Done", saved: true, completed: "2026-07-31", meeting: "Q3 planning — Jul 29" },
  { id: 25, title: "Approve renewal pricing for Northwind", owner: "Marcus Hale", due: "2026-07-28", priority: "Medium", confidence: 89, status: "Done", saved: true, completed: "2026-07-29", meeting: "Northwind kickoff — Jul 22" },
];
